...
<H1 align=left>
    ...
    <TABLE width=900 border=1>
        ...
        <s:iterator value ="goodlist" var="p">
            <TR>
                <TD>
                ...
                <TD>
                    ...
                    <a href="<%=context %>/manager/update?goodId=<s:property value="#p.id"/>">修改商品</a>
                ...
                <TD>
                    ...
                    <a href="<%=context %>/manager/delete?goodId=<s:property value="#p.id"/>">删除商品</a>
                        <%-- <a href="<%=context %>/admin/Category_updateinput?id=<s:property value="#c.id"/>">修改Category</a> --%>
                </TD>
    ...
    <s:if test="#page>1 "><a href="<%=context %>/manager/listgood?page=1"> 首页</a></s:if>

    <s:if test="#page == 1 ">上一页</s:if>

    <s:if test="#page>1 "><a href="<%=context %>/manager/listgood?page=${page-1}"> 上一页</a></s:if>

    <s:if test="#page ==#maxpage">下一页</s:if>

    <s:if test="#page< #maxpage "><a href="<%=context %>/manager/listgood?page=${page + 1}"> 下一页</a></s:if>

    <s:if test="#page == #maxpage">末页</s:if>

    <s:if test="#page< #maxpage  "><a href="<%=context %>/manager/listgood?page=${maxpage}">末页</a></s:if>
